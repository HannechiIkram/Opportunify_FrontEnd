...
import { Card,CardHeader, cardBody,Typography ,List, Button, CardBody } from "@material-tailwind/react";
...
<div id="toast-notification"className={`w-md-screen p-4 text-gray-900 bg-blue-100 bg-opacity-20 rounded-lg mb-3 shadow dark:bg-gray-800 dark:text-gray-300 ${clickedNotificationId === notification._id ? 'bg-white' : ''}`}
  role="alert"
>
    ...
    <div class="flex items-center">
        ...
        <div class="ml-4 text-sm font-normal ">
            ...
            <div class=" font-normal">{notification.type === 'accepted' && <p>Your application has been accepted .</p>}
    {notification.type === 'rejected' && <p>Your application has been rejected .</p>}
    {notification.type === 'newapplication' && <p>You have applied to a new job offer. Your application is under review</p>}</div> 
  
<Link to={`/applications`} ><svg class="w-6 h-6 text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" >
  ...
  <path stroke="currentColor" stroke-width="2" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
            ...
            <span class="text-xs flex items-center font-medium text-blue-600 dark:text-blue-500 "> <svg className="w-2.5 h-2.5 me-1.5 inline-block align-text-top" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
<path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm3.982 13.982a1 1 0 0 1-1.414 0l-3.274-3.274A1.012 1.012 0 0 1 9 10V6a1 1 0 0 1 2 0v3.586l2.982 2.982a1 1 0 0 1 0 1.414Z"/>
</svg> <p>{moment(notification.createdAt).fromNow()}</p></span>   
        </div>
        </div>
    </div>
</div>
