  ...
  y-center items-center h-screen">
    <div className="w-full max-w-screen-lg">
      <div className="text-center  mt-60">
        <Typography variant="h2" className="font-bold text-red-800 mt-80  ml-60 ">Join Us!</Typography>
        <div className={`text-center ${showMessage ? 'opacity-100 transition-opacity duration-500' : 'opacity-0'}`}>
          <Typography variant="paragraph" color="blue-gray" className="text-sm font-normal ml-60 transition-opacity duration-500 ease-in">
            Please Enter your information to register as a Company.
          </Typography>
        </div>
      </div>

      <div className=" rounded-lg p-1  bg-opacity-90 mt-10 ml-80 mb-10 ">
