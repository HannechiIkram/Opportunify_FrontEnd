  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2 mt-7">
          {/* Icon */}
        ...
        <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">Esprit School of Engineering</h2>
        ...
        <div className="flex items-start">
          ...
          <div className="text-sm font-semibold text-white px-1.5 bg-gray-300 rounded-full"></div>
        </div>
      </div>
