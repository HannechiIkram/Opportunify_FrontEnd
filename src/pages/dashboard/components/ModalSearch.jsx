...
function ModalSearch({ id, searchId, modalOpen, setModalOpen }) {
  ...
  const fetchRecentSearches = async () => {
    try {
      ...
      const response = await axios.get('/user/recent-searches', config); // Adjust endpoint as needed
  ...
  const fetchRecentPages = async () => {
    try {
      ...
      const response = await axios.get('/user/recent-pages', config); // Adjust endpoint as needed
  ...
  useEffect(() => {
    ...
    return () => {
      document.removeEventListener('click', clickHandler); // Fixed the typo
    };
  }, [modalOpen]);
  ...
  useEffect(() => {
    ...
    return () => {
      document.removeEventListener('keydown', keyHandler); // Fixed the typo
    };
  }, [modalOpen]);
