...
function DropdownFilter({
  ...
  const toggleFilter = (filter) => {
    ...
    setDropdownOpen(false);
    // Apply filter to the entire page based on selectedFilter value
    // Here you can implement the logic to filter the page content accordingly
    console.log(`Filtering page by: ${filter}`);
  }
        ...
        <div ref={dropdown}>
          ...
          <ul className="mb-4">
            <li className="py-1 px-3">
              <button className="flex items-center w-full" onClick={() => toggleFilter('user')}>
                <span className="text-sm font-medium ml-2">User</span>
              </button>
            </li>
            <li className="py-1 px-3">
              <button className="flex items-center w-full" onClick={() => toggleFilter('offer')}>
                <span className="text-sm font-medium ml-2">Offer</span>
              </button>
            </li>
          </ul>
